        ...
        <AnimatePresence mode="wait">
          {index < words.length ? (
            ...
            >
              ...
              <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-blue-500">
                Chaos.
              </h1>
            </motion.div>
          )}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.div
              style={{ y: imageY }}
              className="z-10 shadow-2xl shadow-blue-900/20 rounded-2xl"
            >
              <img
                src={FOUNDER_IMAGE}
            ...
            <div className="absolute -inset-8 bg-blue-900/30 rounded-full blur-3xl opacity-40 group-hover:opacity-60 transition-opacity duration-500 -z-10"></div>
          </motion.div>
          <motion.div
          ...
          >
            ...
            <motion.div
              variants={textItemVariants}
              className="relative border-blue-500 pl-8 py-4"
            >
              <Quote
                className="absolute top-2 -left-5 text-blue-500/50"
                size={40}
              />
  ...
  return (
    <section ref={targetRef} className="py-16 md:py-24">
      ...
      <div className="relative max-w-3xl mx-auto md:max-w-none">
        ...
        <motion.div
          className="hidden md:block absolute left-1/2 -translate-x-1/2 top-2 w-0.5 bg-blue-500"
        ...
        {/* Mobile timeline bar */}
        <motion.div
          className="md:hidden absolute left-4 top-2 w-0.5 bg-blue-500"
          style={{ height: lineHeight }}
        />
    ...
    >
      ...
      <div className="md:hidden w-full pl-12">
        <div className="absolute left-4 top-1 -translate-x-1/2">
          <div className="w-5 h-5 bg-blue-500 rounded-full border-4 border-black ring-4 ring-blue-500/30"></div>
        </div>
        <div className="bg-gray-900/50 border border-gray-800 p-6 rounded-xl backdrop-blur-sm">
          <p className="text-blue-400 font-semibold text-lg">{event.year}</p>
      ...
      <div className="hidden md:block w-[calc(50%-2rem)]">
        ...
        <div className="bg-gray-900/50 border border-gray-800 p-6 rounded-xl backdrop-blur-sm transition-all duration-300 hover:border-blue-500/50 hover:bg-gray-900 hover:-translate-y-1">
          <p className="text-blue-400 font-semibold text-lg">{event.year}</p>
          <h3 className="text-2xl font-bold text-white mt-1">{event.title}</h3>
          <p className="text-gray-400 mt-2">{event.description}</p>
        </div>
