        ...
        >
            <div style={{ transform: "translateZ(50px)", transformStyle: "preserve-3d" }} className="absolute inset-0 flex items-center justify-center">
                ...
                <motion.div
                    ...
                    className="absolute w-48 h-48 bg-blue-500/20 rounded-full blur-2xl"
                />
                <motion.div
                        ...
                        >
                            ...
                            <form className="space-y-6">
                                <AnimatePresence>
                                    {!isLogin && (
                                        ...
                                        >
                                            ...
                                            <input type="text" placeholder="Full Name" className="w-full bg-gray-800/50 text-white pl-12 pr-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 border border-transparent focus:border-blue-500" />
                                        </motion.div>
                                    )}
                                </AnimatePresence>
                                ...
                                <motion.div variants={formItemVariants} className="relative flex items-center">
                                    ...
                                    <input type="email" placeholder="Email Address" className="w-full bg-gray-800/50 text-white pl-12 pr-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 border border-transparent focus:border-blue-500" />
                                </motion.div>
                                
                                <motion.div variants={formItemVariants} className="relative flex items-center">
                                    <Lock className="absolute left-4 text-gray-500" size={20}/>
                                    <input type={showPassword ? 'text' : 'password'} placeholder="Password" className="w-full bg-gray-800/50 text-white pl-12 pr-12 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 border border-transparent focus:border-blue-500" />
                            ...
                            <motion.p variants={formItemVariants} className="text-center text-sm text-gray-400 mt-8">
                                ...
                                <button onClick={() => setIsLogin(!isLogin)} className="font-semibold text-blue-500 hover:text-blue-400 ml-1 transition-colors">
