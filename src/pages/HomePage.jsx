        ...
        <div className="flex-grow flex flex-col justify-center items-center">
          ...
          >
            <motion.button 
                ...
                className="bg-blue-600 text-white font-bold px-8 py-4 rounded-lg hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/30"
      ...
      <div className="bg-black text-white">
        ...
        <div className="py-24 container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <button 
                onClick={() => setPage("Products")}
                className="border border-gray-700 text-white font-bold px-8 py-3 rounded-lg text-base hover:bg-blue-700 transition-colors"
            >
