                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        >
                            ...
                            <span className="text-2xl font-bold text-white tracking-widest">LAYERS</span>
                        </motion.div>
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            ...
                            <motion.button
                                ...
                                className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 shadow-lg shadow-blue-600/30"
                                whileHover={{ scale: 1.05, y: -2, boxShadow: '0 10px 20px -10px rgba(59, 130, 246, 0.5)' }}
                        ...
                        >
                            ...
                            <hr className="border-white/10 my-6" />
                             <motion.button
                                ...
                                className="w-full flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg text-sm font-medium transition-all duration-300 shadow-lg shadow-blue-600/30"
                             >
                                <User size={16} />
