...
const CustomCursor = () => {
    ...
    return (
        <motion.div
            className="custom-cursor fixed top-0 left-0 w-8 h-8 bg-blue-500 rounded-full pointer-events-none z-50 mix-blend-difference -translate-x-1/2 -translate-y-1/2"
            style={{
